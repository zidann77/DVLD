   ...
   public class clsPerson
    {
     ...
     //   public string FullName { get { return string.Join(" ", new { this.FirstName, this.SecondName, this.ThirdName, this.LastName }); } }
       ...
       private bool _AddNewPerson()
        ...
        public static clsPerson Find(int id)
        {
            ...
            // why find function return boolean 
            ...
            if(isFound)
                  return new clsPerson(id,FirstName,SecondName,ThirdName,LastName,NationalNo,DateOfBirth,Gendor,Address,Phone,Email,NationalityCountryID,ImagePath);
            else
                return null;
        }
